...
from app import CONSULTATION_GRAPH
...
PROTECTED_CASES = [
    ...
    # 주말 복귀 출장: 승인 일정과 개인 사유를 확인하도록 담당 부서 검토로 이관한다.
    (
    ...
    (
        ...
        "개인 일정으로 인해 추가된 비용은 지원 근거가 없습니다",
        "판정: 지원 대상",
    ),
    # 동호회 관리 규정 5.1·5.2: 개설 문의에는 최소 인원과 신청 절차부터 안내한다.
    (
        "동호회 개설을 하고 싶은데 방법은?",
        "최소 5명의 회원",
